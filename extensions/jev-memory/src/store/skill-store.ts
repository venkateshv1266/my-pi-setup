 ...
 *
 * Global skills live in ~/.pi/agent/jev-memory/skills/<slug>/SKILL.md.
...
export class SkillStore {
  ...
  constructor(options: SkillStoreOptions = {}) {
    ...
    this.globalSkillsDir = options.globalSkillsDir ?? path.join(agentRoot, "jev-memory", "skills");
    ...
    this.migrationSentinelPath = options.migrationSentinelPath
      ?? path.join(agentRoot, "jev-memory", ".skills-migrated-to-extension-storage");
  }
